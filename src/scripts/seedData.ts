...
const books = [
    ...
    {
        title: 'Steve Jobs',
        description: 'La biographie autorisée du co-fondateur d\'Apple. Un récit passionnant de l\'homme qui a révolutionné l\'industrie technologique.',
    ...
    {
        title: 'Becoming',
        description: 'Les mémoires intimes et puissantes de l\'ancienne Première Dame Michelle Obama.',
    ...
    {
        title: 'Elon Musk',
        description: 'La biographie définitive du visionnaire derrière Tesla, SpaceX et l\'avenir de l\'humanité.',
        author: ['Ashlee Vance'],
        price: 27.99,
        publishYear: 2015,
        isbn: '978-0062301239',
    ...
    {
        title: 'Gone Girl',
        description: 'Un thriller psychologique captivant sur un mariage qui tourne au cauchemar. Qui dit la vérité ?',
    ...
    },
    {
        ...
        description: 'Un journaliste et une hackeuse enquêtent sur une disparition vieille de 40 ans.',
    ...
    },
    {
        ...
        description: 'Une femme tire sur son mari puis ne dit plus un mot. Un psychothérapeute est obsédé par découvrir pourquoi.',
    ...
    {
        title: 'Dune',
        description: 'Sur la planète désertique d\'Arrakis, une épopée galactique se déroule autour de l\'épice la plus précieuse de l\'univers.',
    ...
    {
        title: 'The Martian',
        description: 'Laissé pour mort sur Mars, un astronaute doit utiliser son ingéniosité pour survivre.',
        author: ['Andy Weir'],
        price: 16.99,
        publishYear: 2011,
        isbn: '978-0553418026',
    ...
    {
        title: 'Neuromancer',
        description: 'Le roman cyberpunk qui a défini le genre. Un hacker est embauché pour l\'ultime piratage.',
    ...
    // FANTASY
    {
        ...
        description: 'L\'histoire de Kvothe, un aventurier légendaire devenu aubergiste, racontant son passé.',
    ...
    },
    {
        ...
        description: 'Dans un monde médiéval fantastique, plusieurs maisons nobles se battent pour le trône.',
    ...
    {
        title: 'The Notebook',
        description: 'Une histoire d\'amour intemporelle qui résiste à toutes les épreuves.',
        ...
        inStock: true,
        featured: false,
        coverUrl: 'https://images.unsplash.com/photo-1516542076529-1ea3854896f2?w=400',
    },
    {
        title: 'Pride and Prejudice',
        description: 'Le classique de Jane Austen sur l\'amour, les préjugés et les malentendus.',
        author: ['Jane Austen'],
        price: 12.99,
        publishYear: 1813,
        isbn: '978-0141439518',
        ...
        inStock: true,
        featured: true,
        coverUrl: 'https://images.unsplash.com/photo-1491841573634-28140fc7ced7?w=400',
    },
];
